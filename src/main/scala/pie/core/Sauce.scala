...
object Tomato2 extends CoreSauce {
  ...
  implicit val sauceToImage: FixedColorSauceToImage[Tomato2.type] = new FixedColorSauceToImage[Tomato2.type](Color.red)
...
object Bechamel2 extends CoreSauce {
  implicit val sauceToImage: FixedColorSauceToImage[Bechamel2.type] = new FixedColorSauceToImage[Bechamel2.type](Color.white)
