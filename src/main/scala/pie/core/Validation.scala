...
import pie.italy.PizzaShop.{correction, validateSauce, validateSize}
...
object Validation {
    ...
    def validateSauce[T](sauce: String)(implicit sauceParser: SauceParser[T]): Either[PizzaError, T] =
        sauceParser(sauce)
